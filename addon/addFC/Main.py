    ...
    def GetResources(self):
        return {'Pixmap': os.path.join(P.AFC_DIR_ICON, 'resent.svg'),
                ...
                'ToolTip': FreeCAD.Qt.translate(
                    'addFC', 'Open the last working file')}
...
class AddFCDisplay():
    ...
    def GetResources(self):
        return {'Pixmap': os.path.join(P.AFC_DIR_ICON, 'display.svg'),
                'Accel': 'D',
                'MenuText': FreeCAD.Qt.translate(
                    'addFC', 'Display'),
                'ToolTip': FreeCAD.Qt.translate(
                    'addFC', 'Isometric view and fit all objects')}
...
class AddFCModelControl():
    ...
    def GetResources(self):
        return {'Pixmap': os.path.join(P.AFC_DIR_ICON, 'control.svg'),
                'Accel': 'C',
                'MenuText': FreeCAD.Qt.translate(
                    'addFC', 'Model Control'),
                'ToolTip': FreeCAD.Qt.translate(
                    'addFC', 'Execute the model control file')}
...
class AddFCModelInfo():
    ...
    def GetResources(self):
        return {'Pixmap': os.path.join(P.AFC_DIR_ICON, 'info.svg'),
                'Accel': 'I',
                'MenuText': FreeCAD.Qt.translate(
                    'addFC', 'Model Information'),
                'ToolTip': FreeCAD.Qt.translate(
                    'addFC', 'Bill of Materials (BOM) and related workflows')}
    ...
    def Activated(self):
        ...
        def tessellation_settings() -> None:
            ts = FreeCAD.Gui.PySideUic.loadUi(os.path.join(
                P.AFC_DIR, 'ui', 'info_tessellation.ui'))
        ...
        def unfold() -> None:
            ...
            Unfold.unfold(w, structure[2], path, unfold_revision())
...
class AddFCProperties():
    ...
    def GetResources(self):
        return {'Pixmap': os.path.join(P.AFC_DIR_ICON, 'properties.svg'),
                'Accel': 'A',
                'MenuText': FreeCAD.Qt.translate(
...
examples: dict = {
    'addFC - Additional files': (
        os.path.join(P.AFC_DIR_EXTRA),
        FreeCAD.Qt.translate(
            'addFC', 'Additional files, such as templates and fonts.'),
    ),
    # documentation:
    'Documentation - English': (
        os.path.join(DOCUMENTATION_PATH, 'documentation_EN.pdf'),
        'Documentation in PDF format in English.',
    ),
    ...
    'Assembly': (
        ...
        'and an exploded view.\nWarning! Potential sheet metal functionality '
        'issues in FreeCAD versions 1.0 and higher.',
    ),
    'Belt Roller Support': (
    ...
    'Pipe': (
        ...
        'Example of creating a pipeline using points.',
    ),
    'RU std: ЕСКД - Модель': (
...
class AddFCAssistant():
    ...
    def GetResources(self):
        return {'Pixmap': os.path.join(P.AFC_DIR_ICON, 'help.svg'),
                'MenuText': FreeCAD.Qt.translate(
                    'addFC', 'Help and Examples'),
                'ToolTip': FreeCAD.Qt.translate(
                    'addFC', 'Help, examples and additional files')}

    def Activated(self):
        w = FreeCAD.Gui.PySideUic.loadUi(os.path.join(
            P.AFC_DIR, 'ui', 'list.ui'))
    ...
    def GetResources(self):
        return {'Pixmap': os.path.join(P.AFC_DIR_ICON, 'library.svg'),
                ...
                'MenuText': FreeCAD.Qt.translate(
                    'addFC', 'Library'),
                'ToolTip': FreeCAD.Qt.translate(
                    'addFC', 'Element and node library')}

    def Activated(self):
        file = os.path.join(P.AFC_DIR, 'toolkit', 'Library.py')
...
class AddFCExplode():
    ...
    def Activated(self):
        file = os.path.join(P.AFC_DIR, 'toolkit', 'Explode.py')
    ...
    def GetResources(self):
        return {'Pixmap': os.path.join(P.AFC_DIR_ICON, 'pipe.svg'),
                'MenuText': FreeCAD.Qt.translate(
                    'addFC', 'Pipe'),
                'ToolTip': FreeCAD.Qt.translate(
                    'addFC', 'Create a pipe using points')}

    def Activated(self):
        file = os.path.join(P.AFC_DIR, 'toolkit', 'Pipe.py')
...
class AddFCSummary():
    ...
    def GetResources(self):
        return {'Pixmap': os.path.join(P.AFC_DIR_ICON, 'summary.svg'),
                'Accel': 'S',
                'MenuText': FreeCAD.Qt.translate(
                    'addFC', 'Summary'),
                'ToolTip': FreeCAD.Qt.translate(
                    'addFC', 'Display information about selected elements')}

    def Activated(self):
        f = os.path.join(P.AFC_DIR, 'toolkit', 'Summary.py')
...
class AddFCIsolation():
    ...
    def GetResources(self):
        return {'Pixmap': os.path.join(P.AFC_DIR_ICON, 'isolation.svg'),
                'Accel': 'X',
                'MenuText': FreeCAD.Qt.translate(
                    'addFC', 'Isolation'),
                'ToolTip': FreeCAD.Qt.translate(
    ...
    def GetResources(self):
        return {'Pixmap': os.path.join(P.AFC_DIR_ICON, 'viewer.svg'),
                'MenuText': FreeCAD.Qt.translate(
                    'addFC', 'Model Viewer'),
                'ToolTip': FreeCAD.Qt.translate(
                    'addFC', 'Export models for viewing')}

    def Activated(self):
        f = os.path.join(P.AFC_DIR, 'toolkit', 'Viewer.py')
